          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-6">
                Open source and free tools for the Aleo Community
              </p>
      ...
      < h1 className = "text-4xl font-bold pb-8 " > Check the tools available</h1 >
        <div className="grid grid-cols-1 gap-8">
          <div className="bg-neutral-200 text-neutral-900 gap-8 rounded-xl flex flex-col md:flex-row justify-between md:items-center px-8 py-16">
            <div className="">
              <h1 className="text-2xl pb-2">Aleo Background Updater</h1>
              <p className="text-sm pb-4">Represent the privacy first blockchain by using the blockchain bg with your preferred pfp in one click</p>
          ...
          <div className="bg-neutral-200 text-neutral-900 gap-8 rounded-xl flex flex-col md:flex-row md:items-center justify-between px-8 py-16">
            <div className="">
              <h1 className="text-2xl pb-2">Aleo Analytics</h1>
          ...
          <div className="bg-neutral-200 text-neutral-900 gap-8 rounded-xl flex flex-col md:flex-row md:items-center justify-between px-8 py-16">
            <div className="">
              <h1 className="text-2xl pb-2">LeoTracker</h1>
